...
def load_data_from_sql():
    ...
    if conn:
        query = "SELECT * FROM vehicle_sales"
...
def load_sample_data():
    ...
    # Sri Lankan vehicle number prefixes
...
# ========================================
# 8. PAGE CONTENT - VEHICLE MANAGEMENT
# ========================================
...
# ========================================
# 9. PAGE CONTENT - CUSTOMER MANAGEMENT
# ========================================
...
# ========================================
    ...
    original_sales_count = len(df[df['Status'] == 'Sold'])
...
# ========================================
# 14. SQL SERVER SETUP INSTRUCTIONS (COMMENTED)
# ========================================
"""
...
CREATE TABLE repairs (
    RepairID NVARCHAR(10) PRIMARY KEY,
...
# ========================================
# 10. PAGE CONTENT - REPAIR MANAGEMENT
# ========================================
    ...
    with tab1:
        ...
        if len(st.session_state.repairs_data) > 0:
            ...
            with col4:
                st.metric("Avg Repair Time", "5-7 days")
        else:
            with col1:
...
# ========================================
# 11. PAGE CONTENT - SUPPLIER MANAGEMENT
# ========================================
